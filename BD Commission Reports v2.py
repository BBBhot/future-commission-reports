...
minDate = datetime.date(2020, 5, 31)
maxDate = datetime.date(2020, 6, 6)
...
data = pandas.read_csv('C:/Users/jkreuger/Downloads/PaymentReport (19).csv', error_bad_lines=False)
