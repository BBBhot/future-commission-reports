...
minDate = datetime.date(2020, 4, 26)
maxDate = datetime.date(2020, 5, 2)
...
data = pandas.read_csv('C:/Users/jkreuger/Downloads/PaymentReport (10).csv', error_bad_lines=False)
...
for i in range(len(testReport)):
    ...
    if item == 'Dues (New)' or item == 'Additional Business(es)' or item == 'Logo Package':
        pass
    else:
        continue
...
print(df)
commissionBD.to_excel(writer, sheet_name = 'Summary')
